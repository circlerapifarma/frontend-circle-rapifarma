...
interface ImageDisplayProps {
    ...
    resolveUrl?: (name: string) => Promise<string>; // nueva
}

const ImageDisplay2: React.FC<ImageDisplayProps> = ({ imageName, alt, style, onClickImage, resolveUrl }) => {
    ...
    const fetchImageUrl = async () => {
      try {
        const url = resolveUrl
          ? await resolveUrl(imageName)
          : await getPresignedUrl(imageName, "get_object");
