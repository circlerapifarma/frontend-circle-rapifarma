    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-50 to-blue-200 p-6">
            ...
            <p className="text-lg text-gray-700 max-w-2xl text-center mb-6">
                Bienvenido al panel principal de CIRCLE. Esta herramienta permite a farmacias gestionar, verificar y analizar los cuadres de caja diarios de manera eficiente y segura.
                Administra ventas, verifica cuadres de caja, consulta reportes por farmacia o por rango de fechas, y mantén el control de sobrantes y faltantes en cada sucursal.
            </p>
            <ul className="text-base text-gray-800 mb-8 list-disc list-inside max-w-xl">
                <li>Agregar y consultar cuadres de caja por farmacia y día.</li>
                <li>Verificar y aprobar cuadres de caja pendientes.</li>
